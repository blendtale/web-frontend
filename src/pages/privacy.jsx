        ...
        <div className="row">
          <div className="col-12 col-md-12 col-lg-12">
            <TextImageRowContainer
              ...
              para="Learn more about Blendtale privacy policy, terms, and other policies you have to accept before using our products, services, websites, apps, and/or platforms."
            />
          </div>
        </div>
        <div className="privacy-policy-content">
          <QuestionAndAnswer heading="Basics">
            <p>
              Blendtale operates the Blendtale.com website, which provides the
              SERVICE.
            </p>
            <p>
            ...
            <p>
              ...
              our Terms and Conditions, which is accessible at Blendtale.com,
              unless otherwise defined in this Privacy Policy.{" "}
            </p>
          </QuestionAndAnswer>
          <QuestionAndAnswer heading="Information Collection and Use">
            <p>
          ...
          <QuestionAndAnswer heading="Log Data">
            <p>
          ...
          <QuestionAndAnswer heading="Cookies">
            <p>
          ...
          <QuestionAndAnswer heading="Service Providers">
            <p>
          ...
          <QuestionAndAnswer heading="Security">
            <p>
          ...
          <QuestionAndAnswer heading="Link to other sites">
            <p>
          ...
          <QuestionAndAnswer heading="Changes to This Privacy Policy">
            <p>
          ...
          <QuestionAndAnswer heading="Contact Us">
            <p>
